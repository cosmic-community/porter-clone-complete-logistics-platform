      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm mb-1">Active Drivers</p>
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm mb-1">Vehicle Types</p>
                <p className="text-3xl font-bold text-gray-900">{vehicleTypes.length}</p>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Link href="/admin/drivers" className="card hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4">
              <div className="bg-green-100 p-3 rounded-lg">
                <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/admin/vehicles" className="card hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4">
              <div className="bg-purple-100 p-3 rounded-lg">
                <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              ...
              <tbody>
                {orders.slice(0, 5).map((order: Order) => (
                  <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-sm">₹{order.metadata?.total_amount}</td>
                  </tr>
                ))}
              </tbody>
            </table>
